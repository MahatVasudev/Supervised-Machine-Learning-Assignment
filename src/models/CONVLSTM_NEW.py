...
from .CONVLSTM import ConvLSTM, ConvLSTMCell, ConvLSTM_NLAYERS
from .Encoder import GridEncoder_SpatioAttention
from .Auto_Encoder import AutoEncoderFire


class CONVLSTM_FIREMODEL(nn.Module):
    def __init__(self, auto_encoder: AutoEncoderFire, seq_len=7, hidden_channels=256):
        super().__init__()
